      ...
      local servers = {
        ...
        pyright = {
          settings = {
            python = {
              analysis = {
                typeCheckingMode = "off", -- or "strict", "off"
                -- Add other Pyright settings as needed
              },
            },
          },
          -- Optional: Configure the root_dir to ensure Pyright scans the correct project directory
          root_dir = function()
            return vim.fn.getcwd() -- Set root_dir to the current working directory
          end,
        },
        -- rust_analyzer = {},
